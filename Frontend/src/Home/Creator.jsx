...
function Creator() {
  ...
  return (
    <div className=" container  mx-auto p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 rounded-full my-5 ms-2">
        {admin && admin.length > 0 ? (
          admin.slice(10, 15).map((element) => {
            return (
              <div key={element._id}>
                <div className="">
                  <img
                  ...
                  />
                  <div className="mt-3 text-center md:ml-[-100px] lg:ml-[-80px]">
                    <p>{element.name}</p>
